...
export interface ApiClienteCliente extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Sobrenome: Attribute.String & Attribute.Required;
...
export interface ApiDespesaDespesa extends Schema.CollectionType {
  ...
  attributes: {
    NomeDespesa: Attribute.String & Attribute.Required;
    Valor: Attribute.String & Attribute.Required;
